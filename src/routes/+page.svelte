...
>
	<div class="relative mb-4 max-w-md pl-8">
		<!-- Added pl-8 to shift logo right -->
		<img
			src="/logo.png"
			alt="Axon Logo"
			class="relative max-w-md"
			style="transform: translate({$position.x}px, {$position.y}px) scale(0.75);"
		/>
	</div>
	<div
	...
	>
		...
		<a
			href="/login"
			class="focus:ring-opacity-80 relative overflow-hidden px-8 py-3 text-sm font-medium text-black shadow-md transition-all duration-300 ease-out hover:scale-105 hover:shadow-lg focus:ring focus:ring-black focus:outline-none active:scale-95"
			style="background: #ffffff;"
		>
			<span class="relative z-10">Login</span>
			<span
				class="absolute inset-0 z-0 bg-white opacity-0 transition-opacity duration-300 ease-out hover:opacity-10"
			></span>
		</a>
		<a
			href="/register"
			class="focus:ring-opacity-80 relative overflow-hidden border-2 border-white px-8 py-3 text-sm font-medium text-white shadow-md transition-all duration-300 ease-out hover:scale-105 hover:shadow-lg focus:ring focus:ring-white focus:outline-none active:scale-95"
			style="background: #000000;"
		>
			<span class="relative z-10">Register</span>
			<span
				class="absolute inset-0 z-0 bg-white opacity-0 transition-opacity duration-300 ease-out hover:opacity-20"
			></span>
		</a>
	</div>
</div>
