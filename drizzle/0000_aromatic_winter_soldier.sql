...
CREATE TABLE "task_assignment" (
	...
	"user_id" text NOT NULL,
	CONSTRAINT "task_assignment_task_id_user_id_pk" PRIMARY KEY("task_id","user_id")
);
--> statement-breakpoint
...
ALTER TABLE "organization_invitation" ADD CONSTRAINT "organization_invitation_invitee_id_user_id_fk" FOREIGN KEY ("invitee_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "task_assignment" ADD CONSTRAINT "task_assignment_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "organization_invitation_unique" ON "organization_invitation" USING btree ("organization_id","invitee_id");
